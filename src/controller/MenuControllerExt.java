	...
	class MenuMouseListener extends MouseAdapter {
		...
		public void mouseEntered(MouseEvent e) {
			...
			if (e.getSource() == menu.getLbHigthScore()) {
				GameSound.getIstance().getAudio(GameSound.BOMB).play();
				ImageIcon highScoreIcon = new ImageIcon(getClass().getResource("/Images/HighScore2.png"));
				menu.getLbHigthScore().setIcon(highScoreIcon);
			}
		...
		public void mouseExited(MouseEvent e) {
			...
			if (e.getSource() == menu.getLbHigthScore()) {
				ImageIcon highScoreIcon = new ImageIcon(getClass().getResource("/Images/HighScore.png"));
				menu.getLbHigthScore().setIcon(highScoreIcon);
			}
			if (e.getSource() == menu.getLbExit()) {
		...
		public void mousePressed(MouseEvent e) {
			...
			if (e.getSource() == menu.getLbHigthScore()) {
				controllerView.setModel(new ReadFileHighScore());

				GameSound.getIstance().getAudio(GameSound.BOMB).play();
				view.myContainer.setShowHighScore();
			}
		}
	};
}
