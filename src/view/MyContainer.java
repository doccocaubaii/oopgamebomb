...
public class MyContainer {
	...
	private static final String TAG_HIGHTSCORE = "tag_highscore";
	...
	public MyContainer(GameView gameView) {
		...
		myContainer.add(mHighScorePanel.highScorePanel, TAG_HIGHTSCORE);
	...
	public HighScorePanel getmHighScorePanel() {
		return mHighScorePanel;
	}
	...
	public void setShowHighScore() {
		...
		mHighScorePanel.highScorePanel.requestFocus();
	}
